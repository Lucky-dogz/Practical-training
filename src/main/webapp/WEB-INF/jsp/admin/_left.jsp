...
<div id="menu_bar">
	...
	<div><a href="${ pageContext.request.contextPath}/admin/prodlist2">> 销售榜单</a></div>
	<div><a href="${ pageContext.request.contextPath}/admin/catelist">> 分类管理</a></div>
<!-- 	<div><a href="prod_list.html">> 用户管理</a></div>
	...
	<div><a href="${ pageContext.request.contextPath}/chart/barPie">> 图表展示</a></div>
