...
<html>
	...
	<input type="button" id="exportBtn1" style="margin:10px;width: 140px;background-color: blue;color: #FFFFFF;height: 30px;border: none;
    ...
    exportBtn1.addEventListener("click" , function(){
        alert("后端导出");
        var exportUrl = rootPath + "admin/export";
